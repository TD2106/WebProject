    ...
    <div class="col-md-4 col-sm-6 col-xs-6">
        ...
        <form>
            <div class="form-group">
                Full Name
                <br>
                <input type="text" class="form-control" placeholder="John Smith" required autofocus>
            </div>
            <div class="form-group">
                Username
                <br>
                <input type="text" class="form-control" placeholder="johnsmith" required>
            </div>
            <div class="form-group">
                Password
                <br>
                <input type="password" id="password" class="form-control" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
            </div>
            <div class="form-group">
                Confirm Password
                <br>
            ...
            <div class="form-group">
                ...
                <label class="radio-inline">
                    <input name="temp" type="radio" checked>Male
                </label>
                <label class="radio-inline">
                    <input name="temp" type="radio">Female
                </label>
            </div>
            <div class="form-group">
                Profile Picture Link
                <br>
                <input type="text" class="form-control" placeholder="http://" pattern="https?://.+" title="Include http://">
            </div>
